		...
		foreach(glob("$dir"."/*", GLOB_ONLYDIR) as $k=> $folder)
		{
			...
			{			
				...
				$managedir = $manager && $dirman 
					? 	"<a href='' id='rename-ssfa-dir-$uid-$f' title='Rename'>".__('', 'file-away')."<i class='fa fa-pencil'></i></a><br>".// Rename
						"<a href='' id='delete-ssfa-dir-$uid-$f' title='Delete'>".__('', 'file-away')."<i class='fa fa-times'></i></a></td>"// Delete
					: 	' &nbsp; '; 
