...
//			"id='ssfa-bulk-action-toggle-$uid'>".__('Disabled', 'file-away')."</a><br>".
		...
		"<div id='ssfa-bulk-action-select-area-$uid' style='display:block;'>".
            "Bulk Actions".
			"<div style='text-align:left; margin-top:5px;'>".
				...
				"</select>".
				"<span id='ssfa-bulk-action-engage-$uid' class='ssfa-bulk-action-engage'>"._x('Do it!', 'Bulk Action Submit Button', 'file-away')."</span>".
			"</div>".
			"<br>".
			"<label for='ssfa-bulk-action-select-all-$uid' id='ssfa-bulkaction-select-all-$uid' style='font-size:12px;'>".
				...
				"data-selectall=\"".__('Select All', 'file-away')."\" data-clearall=\"".__('Select All', 'file-away')."\" /> ".
