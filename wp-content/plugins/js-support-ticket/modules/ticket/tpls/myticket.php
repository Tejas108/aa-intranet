    ...
    if (get_current_user_id() != 0) {
        ...
        <div class="js-row">
            <div class="js-col-xs-12 js-col-md-3 js-myticket-link">
                <a class="js-myticket-link <?php echo $open; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&jstmod=ticket&jstlay=myticket&list=1"); ?>" >
                    <?php
            ...
            <div class="js-col-xs-12 js-col-md-3 js-myticket-link">
                <a class="js-myticket-link <?php echo $answered; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&jstmod=ticket&jstlay=myticket&list=2"); ?>" >
                    <?php
            ...
            <div class="js-col-xs-12 js-col-md-3 js-myticket-link">
                <a class="js-myticket-link <?php echo $overdue; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&jstmod=ticket&jstlay=myticket&list=3"); ?>" >
                    <?php
            ...
            <div class="js-col-xs-12 js-col-md-3 js-myticket-link">
                <a class="js-myticket-link <?php echo $myticket; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&jstmod=ticket&jstlay=myticket&list=4"); ?>" >
                    <?php
