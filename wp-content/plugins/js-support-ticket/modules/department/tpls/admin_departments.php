    ...
    <div class="js-filter-form-list">
        ...
        foreach (jssupportticket::$_data[0] AS $department) {
            ...
            <div class="js-filter-form-data">
                ...
                <div class="js-col-xs-12 js-col-md-1 third js-textaligncenter"><span class="js-filter-form-data-xs"><?php
                echo __('Type', 'js-support-ticket');
                echo " : ";
                ?></span><?php echo $type; ?></div>
                ...
                echo " : ";
                       ...
                       <?php if ($number != 0 || $pagenum > 1) { ?>
                        <a href="?page=department&task=ordering&action=jstask&order=up&departmentid=<?php
                           echo $department->id;
                    ...
                    if ($number < $count) {
                        ?>
                        <a href="?page=department&task=ordering&action=jstask&order=down&departmentid=<?php
                           echo $department->id;
                           echo ($pagenum > 1) ? '&pagenum=' . $pagenum : '';
        ...
        <?php } elseif ($islastordershow) { ?>
                ...
                echo " : ";
                ?></span><a href="?page=department&task=changestatus&action=jstask&departmentid=<?php echo $department->id; ?>"> <img src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $status; ?>"/> </a></div>
