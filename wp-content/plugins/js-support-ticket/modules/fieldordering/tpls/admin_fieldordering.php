...
?>
<a class="js-add-link button" style="float:right;margin:10px 10px 0px 0px;" href="?page=fieldordering&jstlay=adduserfeild"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add User field', 'js-support-ticket'); ?></a>
