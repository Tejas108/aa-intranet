...
<script type="text/javascript">
    ...
    <form id="adminForm" method="post" action="<?php echo admin_url("admin.php?page=fieldordering&task=saveuserfeild"); ?>">
        ...
        <div class="js-form-wrapper">
            ...
            <div class="js-form-field"><?php echo JSSTformfield::text('size', isset(jssupportticket::$_data[0]['userfield']->size) ? jssupportticket::$_data[0]['userfield']->size : '', array('class' => 'inputbox one')); ?></div>
        </div>
        <?php /*
        <div class="js-form-wrapper">
                ...
                foreach (jssupportticket::$_data[0]['userfieldparams'] as $key => $val) {
                    ...
                    <div class="js-form-wrapper">
                        ...
                        <div class="js-col-lg-9 js-col-md-9 no-padding combo-options-fields" id="<?php echo $key; ?>">
                            ...
                            ?>
                            <input id="depandant-field-button" onclick="getNextField( &quot;<?php echo $key; ?> &quot; );" value="Add More" type="button">
                        </div>
                    </div><?php
                }
            }
...
<?php echo JSSTformfield::submitbutton('save', __('Save User Field', 'js-support-ticket'), array('class' => 'button')); ?>
    ...
    <script type="text/javascript">
        ...
        function getNextField(divid) {
            ...
            jQuery("div#" + divid + " #depandant-field-button").before(fieldhtml);
        }
